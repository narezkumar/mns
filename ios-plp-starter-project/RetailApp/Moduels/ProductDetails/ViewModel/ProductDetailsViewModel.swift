...
class ProductDetailsViewModel:ViewModel {
  ...
  convenience init(productRequest: ProductRequest, listingImage: UIImage?, servicesProvider: ServicesProvider) {
    self.init(productRequest: productRequest, listingImage: listingImage, productDetailsService: servicesProvider.productDetailsService, imageService: servicesProvider.imageService, priceFormatter: PriceFormatterImplementation(), informationFormatter: InformationFormatterImplementation())
  }
